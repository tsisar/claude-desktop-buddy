...
static void doCelebrate(uint32_t t) {
  ...
  buddyPrintSprite(P[BUDDY_CELEB_SEQ[beat]], 5, BUDDY_CELEB_YSHIFT[beat], 0xD8FE);
...
static void doDizzy(uint32_t t) {
  ...
  buddyPrintSprite(P[BUDDY_DIZZY_SEQ[beat]], 5, 0, 0xD8FE, BUDDY_DIZZY_XSHIFT[beat]);

  overlayOrbitStars(t, 4);
}
