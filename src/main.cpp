...
#include "gesture.h"
#include "debug.h"
#include "logic/wrap.h"   // wrapInto — shared with the host test suite
...
// Word-wrap (used by HUD, transcript and approval screen) lives in
// logic/wrap.h so the host test suite covers the UTF-8 boundary back-off.
